...
function modern_architecture_scripts() {
	...
	$custom_css = '
		.logo {
			padding-top: '.esc_attr($modern_architecture_logo_top_padding).'px;
			padding-bottom: '.esc_attr($modern_architecture_logo_bottom_padding).'px;
			padding-left: '.esc_attr($modern_architecture_logo_left_padding).'px;
			padding-right: '.esc_attr($modern_architecture_logo_right_padding).'px;
		}
		#our-services {
			padding-top: '.esc_attr($modern_architecture_what_we_do_section_padding).'px;
			padding-bottom: '.esc_attr($modern_architecture_what_we_do_section_padding).'px;
		}
	';
